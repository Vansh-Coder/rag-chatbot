...
export default function Home() {
  return (
    <div className="relative z-0">
      ...
      <div
        className="relative flex h-screen w-full overflow-hidden bg-black/[0.96] antialiased md:items-center md:justify-center">
        <div
          className={cn(
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-0">
          ...
          <p
            ...
            Simply upload your study documents and ask the chatbot any questions. 
